...
<div class="modal-body">
	<div class="alert alert-warning">
		...
		<p>
			{l s='This module was not verified by YajesApps hence we cannot certify that it works well in your country and that it complies with our quality requirements.'}
	...
	<p>
		...
		<a class="_blank" href="http://addons.prestashop.com/">{l s='Click here to browse YajesApps Addons.'}</a>
	</p>
</div>
