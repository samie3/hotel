...
$(document).ready(function() {
    ...
    $(document).on('yajesapps:updateRoomOccupancy', function(e) {
        BookingForm.refresh();
    });

    $(document).on('yajesapps:updateRoomQuantity', function(e) {
        BookingForm.refresh();
    });
...
var BookingForm = {
    ...
    init: function() {
        ...
        $(document).trigger("yajesapps:afterBookingFormInit");
    },
