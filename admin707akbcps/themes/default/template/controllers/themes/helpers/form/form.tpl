	...
	<div class="defaultForm form-horizontal">
			...
			<div class="panel">
				<div class="row">
					<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<img class="img-responsive" alt="YajesApps Addons" src="themes/default/img/prestashop-addons-logo.png">
					</div>
					<div class="col-lg-4 col-lg-offset-1 col-md-4 col-sm-7 col-xs-12 addons-style-search-bar">
						...
						<label>{l s='Search on YajesApps Marketplace:'}</label>
						<div class="input-group">
							<input id="addons-search-box" class="form-control" type="text" autocomplete="off" name="query" value="" placeholder="Search on YajesApps Marketplace">
			...
			<div class="panel" id="">
				...
				<div class="form-wrapper">
					<div class="form-group">
						<p>{l s='To add a new theme, simply connect to your YajesApps Addons account: your new theme will be automatically imported to your shop.'}</p>
		...
		{/if}
			...
			<div class="alert alert-info">
				...
				<p>{l s='Please note that for security reasons, you can only add themes that are being distributed on YajesApps Addons, the official marketplace.'}</p>
