...
<div class="untrusted-content-action">
	...
	<div class="modal-body">
		<div class="alert alert-warning">
			<h3>{l s='Do you want to install this module that could not be verified by YajesApps?'}</h3>

			<p>{l s="This generally happens when the module isn't distributed through our official marketplace, YajesApps Addons - or when your server failed to communicate with YajesApps Addons."}</p>
		</div>
	...
	<div class="modal-footer">
		<div class="alert alert-info">
			<p>
				{l s='Since you may not have downloaded this module from YajesApps Addons, we cannot assert that the module is not adding some undisclosed functionalities. We advise you to install it only if you trust the source of the content.'}
...
<div class="untrusted-content-more-info" style="display:none;">
	...
	<div class="modal-body">
		...
		<p>{l s="YajesApps, being an open-source software, has an awesome community with a long history of developing and sharing high quality modules. Before installing this module, making sure its author is a known community member is always a good idea (by checking [1]our forum[/1] for instance)." tags=['<a href="https://forums.yajesapps.com/">']}</p>
		...
		<p>{l s="Otherwise you can look for similar modules on the official marketplace. [1]Click here to browse YajesApps Addons[/1]." tags=['<a class="catalog-link" href="https://yajesapps.com/addons/" target="_blank">']}
