...
<div class="row">
	<div class="col-lg-4">
		<div class="panel">
			<h3>{l s='Search YajesApps.com/blog'}</h3>
			<a href="https://yajesapps.com/?s={$query}" class="btn btn-default _blank">{l s='Go to the documentation'}</a>
		</div>
	</div>
	<div class="col-lg-4">
		<div class="panel">
			<h3>{l s='Search YajesApps.com/addons'}</h3>
			<a href="https://yajesapps.com/addons/?add={$query}" class="btn btn-default _blank">{l s='Go to Addons'}</a>
		</div>
	</div>
	<div class="col-lg-4">
		<div class="panel">
			<h3>{l s='Search forums.yajesapps.com'}</h3>
			<a href="https://forums.yajesapps.com/search?term={$query}" class="btn btn-default _blank">{l s='Go to the Forum'}</a>
		</div>
	</div>
</div>
