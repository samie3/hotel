														...
														<div class="row room_demand_block">
															...
															<div class="col-xs-4">
																{if ($product.show_price && !isset($restricted_country_mode)) || isset($groups)}
																	<span class="pull-right">{if !$priceDisplay}{convertPrice price=$product.price_tax_incl}{else}{convertPrice price=$product.price_tax_exc}{/if}{if $product.price_calculation_method == Product::PRICE_CALCULATION_METHOD_PER_DAY}{if $lang_iso == 'ar'}/ليلة{else}{l s='/Night'}{/if}{/if}</span>
