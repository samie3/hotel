    ...
    <div class="row">
        {block name='order_standalone_product_image'}
            <div class="col-xs-3 col-sm-2">
                <a href="{$link->getProductLink($product.id_product)|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" >
        ...
        {block name='order_standalone_product_detail'}
            <div class="col-xs-9 col-sm-10 info-wrap">
                <div class="row">
                    <div class="col-xs-12">
                        <a href="{$link->getProductLink($product.id_product)|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}"  class="product-name">
