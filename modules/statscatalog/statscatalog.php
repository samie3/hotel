...
class StatsCatalog extends Module
{
    ...
    public function hookAdminStatsModules($params)
    {
		...
		$html .='
				<p>
					<strong>'.$this->l('Note: ').'</strong>'.$this->l('You must enable the "Save global page views" option from ').'<a href="'.$link.'" target="_blank">Data mining for statistics</a>'.$this->l(' module for accurate data, or use the YajesApps Google Analytics module.').'
				</p>
			</div>';
