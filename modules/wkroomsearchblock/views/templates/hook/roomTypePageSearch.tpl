						...
						<div class="row">
							<div class="col-sm-9 form-group">
								<div class="filter_header row">
									<div class="col-sm-12">
										<p>{if $lang_iso == 'ar'}نتائج البحث عن{else}{l s='Searched results for' mod='wkroomsearchblock'}{/if}:
			...
			<div class="header-rmsearch-wrapper">
				<div class="container">
					<div class="filter_header">
						<p>{if $lang_iso == 'ar'}نتائج البحث عن{else}{l s='Searched results for' mod='wkroomsearchblock'}{/if}</p>
					</div>
					{* search form *}
