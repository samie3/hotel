                        ...
                        {block name='shopping_cart_room_type_booking_information'}
                            ...
                            <div class="room_duration_block">
                                <div class="col-sm-3 col-xs-6">
                                    ...
                                    <p class="room_duration_block_value">{$rm_v['data_form']|date_format:"%d %B, %Y"}{if $is_full_date} {$rm_v['data_form']|date_format:"%H:%M"}{/if}</p>
                                </div>
                                <div class="col-sm-3 col-xs-6">
                                    <p class="room_duration_block_head">{l s='CHECK OUT'}</p>
                                    <p class="room_duration_block_value">{$rm_v['data_to']|date_format:"%d %B, %Y"}{if $is_full_date} {$rm_v['data_to']|date_format:"%H:%M"}{/if}</p>
                                </div>
                                ...
                                {block name='shopping_cart_room_type_total_price'}
                                    <div class="col-sm-5">
                                        <div class="total_price_block col-xs-12">
                                            ...
                                            <p class="total_price_detial">
                                                {l s='Total price for'} {$rm_v['num_days']} {if $lang_iso == 'ar'}ليلة (ليالي){else}{l s='Night(s) stay'}{/if}{if $display_tax_label}{if $priceDisplay} {l s='(Excl.'} {else}{l s='(Incl.'}{/if} {l s='all taxes.)'}{/if}
                                            </p>
                                        </div>
                                    </div>
                                {/block}
        ...
        {block name='shopping_cart_proceed_action'}
            <div class="row">
                <div class="col-sm-12 proceed_btn_block">
                    <a class="btn btn-default button button-medium pull-right" href="{$link->getPageLink('order-opc', null, null, ['proceed_to_customer_dtl' => 1])}" title="{if $lang_iso == 'ar'}متابعة الدفع{else}Proceed to checkout{/if}" rel="nofollow">
                        <span>
