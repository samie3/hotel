                ...
                {block name='booking_form_hotel_location'}
                    {if isset($id_hotel) && $id_hotel}
                        <div class="form-group htl_location_block">
                            <label for="" class="control-label">{if $lang_iso == 'ar'}موقع الفندق{else}{l s='Hotel Location'}{/if}</label>
                            ...
                            <div class="row">
                                {block name='booking_form_dates'}
                                    <div class="form-group col-sm-12">
                                        <label class="control-label">{if $lang_iso == 'ar'}تسجيل الوصول - تسجيل المغادرة{else}{l s='Check In - Check Out'}{/if}</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12"{if !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
                                            {if isset($occupancy_required_for_booking) && $occupancy_required_for_booking}
                                                <label class="control-label">{if $lang_iso == 'ar'}الضيوف{else}{l s='Guests'}{/if}</label>
                                ...
                                {block name='booking_form_price_information'}
                                    {if (isset($has_room_type_demands) && $has_room_type_demands) || (isset($service_products_exists) && $service_products_exists)}
                                        ...
                                        <div class="row price_desc_block">
                                            <div class="col-sm-6">
                                                <label class="control-label">{if $lang_iso == 'ar'}سعر الغرفة{else}{l s='Room Price'}{/if}</label>
                                                    <p>
                                            ...
                                            <div class="col-sm-6">
                                                <label class="control-label">{if $lang_iso == 'ar'}الخدمات الإضافية{else}{l s='Extra Services'}{/if}</label>
                                        ...
                                        <div class="row">
                                            {block name='booking_form_total_price'}
                                                <div class="total_price_block col-xs-7 form-group">
                                                    <label class="control-label">{if $lang_iso == 'ar'}الإجمالي{else}{l s='Total'}{/if}</label>
                                                    <p>
                                            ...
                                            {block name='booking_form_available_quantity'}
                                                {if $total_available_rooms <= $warning_count}
                                                    <div class="col-xs-5 form-group text-right num_quantity_alert">
                                                        ...
                                                        {if $lang_iso == 'ar'} {if $total_available_rooms > 1} {l s='الغرف المتبقية'} {else} {l s='الغرفة المتبقية'} {/if}{else} {if $total_available_rooms > 1} {l s='rooms left!'} {else} {l s='room left!'} {/if}{/if}
                                                    </div>
                                                {/if}
                                            {/block}
                                        </div>
                                                ...
                                                {block name='booking_form_book_now_button'}
                                                    <p id="add_to_cart" class="buttons_bottom_block no-print">
                                                        <button type="submit" name="Submit" class="exclusive book_now_submit">
                                                            <span>
                                                                {if isset($content_only) && $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}{if $lang_iso == 'ar'}احجز الآن{else}{l s='Book Now'}{/if}{/if}
                                                            </span>
