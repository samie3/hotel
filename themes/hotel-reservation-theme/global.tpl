...
{addJsDefL name=RangePickerCheckin}{if $lang_iso == 'ar'}تسجيل الوصول{else}{l s='Check-in'}{/if}{/addJsDefL}
{addJsDefL name=RangePickerCheckout}{if $lang_iso == 'ar'}تسجيل المغادرة{else}{l s='Check-out'}{/if}{/addJsDefL}
