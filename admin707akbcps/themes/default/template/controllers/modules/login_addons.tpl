	...
	{if !isset($logged_on_addons) || !$logged_on_addons}
		...
		{else}
			...
			<form id="addons_login_form" method="post" >
				<div>
					<a href="{$addons_register_link|escape:'html':'UTF-8'}"><img class="img-responsive center-block" src="themes/default/img/prestashop-addons-logo.png" alt="Logo YajesApps Addons"/></a>
					<h3 class="text-center">{l s="Connect your shop with YajesApps's marketplace in order to automatically import all your Addons purchases."}</h3>
					<hr />
				</div>
				<div class="row">
					<div class="col-md-6">
						<h4>{l s="Don't have an account?"}</h4>
						<p class='text-justify'>{l s="Discover the Power of YajesApps Addons! Explore the YajesApps Official Marketplace and find over 3 500 innovative modules and themes that optimize conversion rates, increase traffic, build customer loyalty and maximize your productivity"}</p>
					</div>
					<div class="col-md-6">
						<h4>{l s='Connect to YajesApps Addons'}</h4>
