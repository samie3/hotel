...
class WebserviceSpecificManagementHotelAri extends ObjectModel implements WebserviceSpecificManagementInterface
{
    ...
    {
        if ($ariInfoArray) {
            // if date wise breakup is requested the parent node will be 'hotel_aris' as per other APIs in yajesapps (orders > order)
        ...
        // wrap with the common parent header of yajesapps xml api responses
        $this->output = $this->objOutput->getObjectRender()->overrideContent($this->output);
