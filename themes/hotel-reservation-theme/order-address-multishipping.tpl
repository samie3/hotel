...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				{/if}
		        <button type="submit" name="processAddress" class="button btn btn-default button-medium"><span>{if $lang_iso == 'ar'}متابعة الدفع{else}{l s='Proceed to checkout'}{/if}<i class="icon-chevron-right right"></i></span></button>
			</p>
		</form>
{else}
	</div>
