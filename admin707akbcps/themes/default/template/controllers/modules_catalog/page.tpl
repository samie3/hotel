...
<div id="catalog-center-column">
    {if isset($modules) && $modules}
        ...
        <div class="panel explore-panel text-center">
            {l s='Explore all addon of YajesApps'}&nbsp;
            <a href="https://yajesapps.com/addons/" class="btn btn-primary btn-lg">{l s='YajesApps Addons'}</a>
        </div>
    {/if}
    {if isset($themes) && $themes}
        ...
        <div class="panel explore-panel text-center">
            {l s='Explore all themes of YajesApps'}&nbsp;
            <a href="https://store.webkul.com/yajesapps/responsive.html" class="btn btn-primary btn-lg">{l s='YajesApps Themes'}</a>
        </div>
    {/if}
</div>
