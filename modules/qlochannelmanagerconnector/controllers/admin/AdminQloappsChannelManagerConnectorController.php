...
class AdminyajesappsChannelManagerConnectorController extends ModuleAdminController
{
    ...
    public function renderList()
    {
        if ($channelManagerBookings = QcmcChannelManagerBooking::getChannelManagerBookings(0, 'DESC')) {
            ...
            $this->content .= $this->context->smarty->fetch(
                _PS_MODULE_DIR_.
                'qlochannelmanagerconnector/views/templates/admin/yajesapps_channel_manager_connector/channel_manager_connect_info.tpl'
            );
        }
    }
