...
{/if}
		...
		var errorLogin = '{l s='Unable to connect to Addons server. Please check your credentials and your Internet connection.' js=1}';
		...
		<nav id="header_infos" role="navigation">
			<div class="navbar-header">
				...
				{/if}
									...
									<ul id="header_lang" class="nav navbar-nav navbar-right" style="margin:0;display:flex;align-items:center;font-size:13px;font-weight:bold;">
						<li><a href="lang_switch.php?id_lang=1&amp;redirect={$smarty.server.REQUEST_URI|urlencode}" title="English" style="padding:10px 14px;color:#fff;opacity:0.75;text-decoration:none;border-left:1px solid rgba(255,255,255,0.15);">EN</a></li>
						<li><a href="lang_switch.php?id_lang=3&amp;redirect={$smarty.server.REQUEST_URI|urlencode}" title="العربية" style="padding:10px 14px;color:#fff;opacity:0.75;text-decoration:none;">AR</a></li>
					</ul>
...
{* Google Translate *}
<div id="google_translate_element" style="position:fixed;bottom:10px;right:10px;z-index:9999;background:white;padding:3px;border-radius:5px;box-shadow:0 0 5px rgba(0,0,0,0.2);display:none;"></div>
<script type="text/javascript">
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit3"></script>
