...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if} {if isset($language_is_rtl) && $language_is_rtl}dir="rtl"{/if} style="{if $page_name == 'index'}height: 100%;{/if}">
	<head>
		<meta charset="utf-8" />
		<title>{if $lang_iso == 'ar'}{$meta_title|escape:'html':'UTF-8'|regex_replace:'/ - Lavipark Hotel/':''}{else}{$meta_title|escape:'html':'UTF-8'}{/if}</title>
		...
		{/if}
		<meta name="generator" content="YajesApps" />
		...
		<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;500;600;700&amp;family=Almarai:wght@300;400;700;800&amp;family=Inter:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet" type="text/css">
</head>
						...
						<div class="header-top">
							<div class="container">
								<div class="row">
									<div class="col-xs-12">
										<div id="header_logo">
										<a href="{$link->getPageLink('index', true)}" title="{$shop_name|escape:'html':'UTF-8'}">
