												...
												{if $have_image}
													<span id="view_full_size">
														...
														{else}
															...
															<!-- {if !$content_only} -->
																<span class="span_link no-print">{if $lang_iso == 'ar'}عرض أكبر{else}{l s='View larger'}{/if}</span>
															{/if} 
														{/if}
													</span>
												{else}
													<span id="view_full_size">
														...
														{* {if !$content_only}
															<span class="span_link">
																{if $lang_iso == 'ar'}عرض أكبر{else}{l s='View larger'}{/if}
															</span>
														{/if} *}
													</span>
												{/if}
												...
												<div id="product_info_tab_information">
														...
														{if isset($room_type_info['adults']) && isset($room_type_info['children']) }
															<div class="info_margin_div">
																<div class="room_info_heading">
																	<span>{if $lang_iso == 'ar'}السعة القصوى{else}{l s='Max Capacity'}{/if}</span>
																</div>
													...
													{block name='product_info_tab_room_timing'}
														{if isset($id_hotel) && $id_hotel}
															<div class="info_margin_div">
																<div class="room_info_heading">
																	<span>{if $lang_iso == 'ar'}وقت تسجيل الوصول - تسجيل المغادرة{else}{l s='Check-in and check-out time'}{/if}</span>
																</div>
																<div class="room_info_content">
																	<p>{if $lang_iso == 'ar'}تسجيل الوصول: {else}{l s='Check-in: '}{/if}{$hotel_check_in|escape:'html':'UTF-8'}</p>
																	<p>{if $lang_iso == 'ar'}تسجيل المغادرة: {else}{l s='Check-out: '}{/if}{$hotel_check_out|escape:'html':'UTF-8'}</p>
																</div>
															</div>
														{/if}
													{/block}
													{block name='product_info_tab_room_bed_type'}
														{if isset($selected_bed_types) && $selected_bed_types && isset($bed_types_info) && $bed_types_info}
															<div class="info_margin_div">
																<div class="room_info_heading">
																	<span>{if $lang_iso == 'ar'}أنواع الأسرّة{else}{l s='Bed Types'}{/if}</span>
																</div>
																<div class="room_info_content">
													...
													{if isset($id_hotel) && $id_hotel}
														...
														{block name='product_info_tab_hotel_description'}
															{if isset($hotel_description) && $hotel_description}
																<div class="info_margin_div">
																	<div class="room_info_heading">
																		<span>{if $lang_iso == 'ar'}وصف الفندق{else}{l s='Hotel Description'}{/if}</span>
																	</div>
																	<div class="room_info_content">
																		{$hotel_description}
																	</div>
													...
													{block name='product_info_tab_hotel_images'}
														{if isset($hotel_has_images) && $hotel_has_images}
															<div class="room_info_hotel_images_wrap">
																<div class="info_margin_div">
																	<div class="room_info_heading">
																		<span>{if $lang_iso == 'ar'}صور الفندق{else}{l s='Hotel Images'}{/if}</span>
																	</div>
																	...
																	<a class="btn btn-primary btn-show-more-images hide" data-id-product="{$product->id}" data-next-page="1">
																		<span>{if $lang_iso == 'ar'}عرض المزيد{else}{l s='SHOW MORE'}{/if}</span>
																	</a>
																</div>
															</div>
														{/if}
													...
													{block name='product_info_tab_hotel_policies'}
														{if isset($hotel_policies) && $hotel_policies}
															<div class="info_margin_div">
																<div class="room_info_heading">
																	<span>{if $lang_iso == 'ar'}سياسات الفندق{else}{l s='Hotel Policies'}{/if}</span>
																</div>
																<div class="room_info_content">
											...
											{if isset($id_hotel) && $id_hotel}
												<div id="refund_policies_tab" class="tab-pane card">
													{if isset($isHotelRefundable) && $isHotelRefundable}
														...
														{/if}
													{else}
														<span class="non_refundable_txt error_msg">{if $lang_iso == 'ar'}غير قابل للاسترداد{else}{l s='Non Refundable'}{/if}</span>
													{/if}
												</div>
											{/if}
										{/block}
