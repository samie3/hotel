...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="/img/logo.png" width="123px" alt="Lavipark Hotel" />
		</h1>
	...
	<div id="shop-img"><img src="{$img_dir}logo-admin.png" alt="{$shop_name}" width="136px" height="136px" /></div>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
				...
				&copy; Lavipark Hotel - All rights reserved
