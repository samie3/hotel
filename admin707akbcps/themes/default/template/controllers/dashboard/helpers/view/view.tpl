            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <section class="dash_links widget panel">
                        <h3><i class="icon-link"></i> {l s="Resources"}</h3>
                            <dl>
                                <dt><a href="https://laviparkhotels.com/#" class="_blank">{l s="Documentation"}</a></dt>
                                <dd>{l s="User Guide"}</dd>
                            </dl>
                            <dl>
                                <dt><a href="https://laviparkhotels.com/#" class="_blank">{l s="Support Forum"}</a></dt>
                                <dd>{l s="Get help and support"}</dd>
                            </dl>
                            <dl>
                                <dt><a href="https://laviparkhotels.com/#" class="_blank">{l s="Addons"}</a></dt>
                                <dd>{l s="Enhance your store Hotel modules"}</dd>
                            </dl>
                            <dl>
                                <dt><a href="https://laviparkhotels.com/contact" class="_blank">{l s="Contact Us"}</a></dt>
                                <dd>{l s="Reach out to our team"}</dd>
                            </dl>
                    </section>
                </div>
            </div>
