...
class HotelHelper
{
    ...
    public function insertDefaultHotelEntries()
    {
        ...
        $homeBannerTitleLang = array(
            'en' => 'Masat Almshaer Hotel',
            'nl' => 'Masat Almshaer Hotel',
            'fr' => 'Hôtel Prime',
            'de' => 'Masat Almshaer Hotel',
            'ru' => 'Отель Prime',
            'es' => 'Masat Almshaer Hotel',
        );
        ...
        Configuration::updateValue('PS_SHOP_ADDR1', 'The Masat Almshaer Hotel, Monticello Dr, Montgomery, 10010');
        ...
        $htlTagLineLang = array(
            ...
            'ar' => 'مكان يجمع بين الراحة والفخامة مع الطبيعة!',
        );
        ...
        $htlShortDescLang = array(
            ...
            'ar' => 'نقدم غرفاً أنيقة وتناول طعام راقٍ وخدمة اهتمامية لإقامة لا تُنسى.',
        );
    ...
    public function saveDummyHotelBranchInfo()
    {
        ...
        $htlShortDescLang = array(
            'en' => 'The Masat Almshaer Hotel is the perfect destination for both business and leisure travelers seeking a memorable stay.',
            'nl' => 'Masat Almshaer Hotel is de perfecte bestemming voor zowel zakenreizigers als vakantiegangers die op zoek zijn naar een onvergetelijk verblijf.',
            ...
            'de' => 'Das Masat Almshaer Hotel ist das perfekte Ziel für Geschäfts- und Urlaubsreisende, die einen unvergesslichen Aufenthalt wünschen.',
            'ru' => 'Отель Prime является идеальным местом для деловых путешественников и туристов, желающих провести незабываемый отдых.',
            'es' => 'El Masat Almshaer Hotel es el destino perfecto tanto para viajeros de negocios como de placer que buscan una estancia memorable.',
        );

        $htlDescLang = array(
            'en' => '<div>
                <h4><strong>Welcome to The Masat Almshaer Hotel!</strong></h4>
                <br />
                <div>Our hotel is the perfect destination for both business and leisure travelers seeking a memorable stay.</div>
                <br />
                <div>Benefits of staying at The Masat Almshaer Hotel!</div>
                <br />
                ...
                <div>At The Masat Almshaer Hotel, we take pride in delivering exceptional service to our guests. From the moment you step
                ...
                <div>Ready to experience the epitome of luxury and comfort? Book your stay at The Masat Almshaer Hotel today and let us
            ...
            'nl' => '<div>
                <h4><strong>Welkom bij Masat Almshaer Hotel!</strong></h4>
                <br />
                ...
                <br />
                <div>Voordelen van een verblijf in The Masat Almshaer Hotel!</div>
                <br />
                ...
                <div>Bij The Masat Almshaer Hotel zijn we er trots op dat we onze gasten uitzonderlijke service kunnen bieden. Vanaf het moment dat je stapt
                ...
                <div>Klaar om het toppunt van luxe en comfort te ervaren? Boek vandaag nog uw verblijf in The Masat Almshaer Hotel en laat het ons weten
            ...
            'de' => '<div>
                ...
                <div>Im Masat Almshaer Hotel sind wir stolz darauf, unseren Gästen außergewöhnlichen Service zu bieten. Von dem Moment an, in dem Sie treten
                ...
                <div>Sind Sie bereit, den Inbegriff von Luxus und Komfort zu erleben? Buchen Sie noch heute Ihren Aufenthalt im Masat Almshaer Hotel und überlassen Sie es uns
            ...
            'es' => '<div>
                <h4><strong>¡Bienvenido a The Masat Almshaer Hotel!</strong></h4>
                <br />
                ...
                <br />
                <div>¡Beneficios de alojarse en The Masat Almshaer Hotel!</div>
                <br />
                ...
                <div>En The Masat Almshaer Hotel, nos enorgullecemos de brindar un servicio excepcional a nuestros huéspedes. Desde el momento en que das un paso
                ...
                <div>¿Listo para experimentar el epítome del lujo y la comodidad? Reserva hoy tu estancia en The Masat Almshaer Hotel y déjanos
        ...
        foreach ($languages as $lang) {
            $obj_hotel_info->hotel_name[$lang['id_lang']] = 'The Masat Almshaer Hotel';
        ...
        $objAddress->phone = '+966 12 538 4066';
        $objAddress->city = 'Makkah';
        $objAddress->id_state = $state_id;
        $objAddress->id_country = $def_cont_id;
        $objAddress->postcode = Tools::generateRandomZipcode($def_cont_id);
        $objAddress->address1 = 'Al Aziziyah, Makkah, Saudi Arabia';
        $objAddress->alias = 'Lavi Park Hotels Group';
        $objAddress->lastname = 'Lavi Park Hotels Group';
        $objAddress->firstname = 'Lavi Park Hotels Group';
        ...
        if (count($states) > 0) {
            if (!empty($cat_state)) {
                $cat_city = $this->addCategory(array('name' => 'Makkah', 'group_ids' => $grp_ids, 'parent_category' => $cat_state));
            }
        } else {
            $cat_city = $this->addCategory(array('name' => 'Makkah', 'group_ids' => $grp_ids, 'parent_category' => $cat_country));
        }
        if (!empty($cat_city)) {
            if ($cat_hotel = $this->addCategory(array(
                    'name' => 'The Masat Almshaer Hotel',
                    'group_ids' => $grp_ids,
