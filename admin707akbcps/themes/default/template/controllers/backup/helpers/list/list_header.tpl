...
{block name="override_header"}
	...
	{/if}
		...
		<div class="alert alert-warning">
			...
			<ol>
				<li>{l s='YajesApps is not responsible for your database, its backups and/or recovery.'}</li>
				<li>{l s='YajesApps is open-source software. You are using it at your own risk under the license agreement.'}</li>
		...
		<div class="alert alert-info">
			...
			<br />
			{l s='Your shop is hosted by YajesApps. Although you can create backup files here below, there are core settings you cannot access for security reasons, like the database management. Thus, only our team can proceed to a restoration.'}
		</div>
		{else}
		<div class="alert alert-info">
