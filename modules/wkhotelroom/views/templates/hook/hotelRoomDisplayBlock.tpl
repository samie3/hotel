                                        ...
                                        <div class="col-sm-12 col-md-6 margin-btm-30">
                                            ...
                                            <div class="hotelRoomDescContainer">
                                                {block name='hotel_room_block_room_type_description'}
                                                        ...
                                                        {if $roomDisplay.show_price && !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
                                                            <p class="htlRoomTypePriceText pull-right">
                                                                ...
                                                                <span class="wk_roomType_price_type">
                                                                    /&nbsp;{if $lang_iso == 'ar'}لليلة{else}{l s='Per Night' mod='wkhotelroom'}{/if}
                                                                </span>
                                                            </p>
                                                        {/if}
                                                    </div>
                                                    ...
                                                    <div class="htlRoomTypeDescExtras"><span class='htlRoomTypeDescReadmore'>...{if $lang_iso == 'ar'}...اقرأ المزيد{else}{l s='Read More.' mod='wkhotelroom'}{/if}</span><span class='htlRoomTypeDescReadless'>...{if $lang_iso == 'ar'}...اقرأ أقل{else}{l s='Read Less.' mod='wkhotelroom'}{/if}</span></div>
                                                {/block}
