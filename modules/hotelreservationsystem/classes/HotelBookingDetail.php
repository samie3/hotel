...
class HotelBookingDetail extends ObjectModel
{
    ...
    /**
     * [createyajesappsBookingByChannels create booking on yajesapps commig from different channels]
     * @param  [array] $params [array containing details of orders]
     * @return [boolean] [true if order is created or returns false]
     */
    public function createyajesappsBookingByChannels($params)
    {
        $this->errors = array();
    ...
    /**
     * [createQloCustomerChannelCustomerInfo create customer in yajesapps from supplied information from channel manager]
    ...
    /**
     * [createQloCustomerAddressByChannelCustomerInfo create customer's Address in yajesapps from supplied information from channel manager]
     * @param  [array] $params [array containg customer information]
    ...
    /**
     * [createQloCartForBookingFromChannel create cart in yajesapps from supplied cart information from channel manager]
